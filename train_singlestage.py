...
from loss import WeightedL2Loss, WeightedCosineSimilarity
import os
import time
...
def main():
    ...
    default_config_path = '/sdf/home/y/youngsam/sw/dune/siren-t/config/siren_vxyzt48-slurm.yaml'
